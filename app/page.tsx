...
const ALERTS = [
  { id: 1, sev: "critical", cat: "vendor_guardrails", title: "Anthropic Replaces RSP with Nonbinding Frontier Safety Roadmap", summary: "Previous hard commitment to pause training if capabilities outstrip controls removed. Shift to public goals and flexible framework citing competitive pressure.", source: "CNN Business", url: "https://www.anthropic.com/news/frontier-safety-roadmap", vendor: "Anthropic", ts: "2026-02-25T14:30:00Z", isNew: true, score: 95 },
  { id: 2, sev: "critical", cat: "enforcement", title: "Pentagon Threatens Defense Production Act Against Anthropic Over AI Red Lines", summary: "DoD demanded 'any lawful use' language in $200M contract. Would permit autonomous weapons and mass surveillance deployment. Anthropic CEO declined. DPA invocation threatened.", source: "Lawfare", url: "https://www.lawfaremedia.org/article/the-defense-production-act-and-ai", vendor: "Anthropic", ts: "2026-02-27T17:01:00Z", isNew: true, score: 98 },
  { id: 3, sev: "critical", cat: "safety_research", title: "Industry-Wide Safety Guardrail Erosion Under Competitive Pressure", summary: "All major AI labs loosening safety guardrails. Global AI summits shifting from guardrails to commercialization. Voluntary pledges failing as race dynamics intensify.", source: "Axios", url: "https://www.axios.com/2025/12/31/ai-safety-guardrails-big-tech", vendor: null, ts: "2026-03-03T08:00:00Z", isNew: true, score: 92 },
  { id: 4, sev: "high", cat: "vendor_guardrails", title: "OpenAI Strikes Pentagon Deal Hours After Anthropic Standoff", summary: "Amended deal reportedly includes surveillance limits but contract language permits broad military use. Details under continued review.", source: "CNBC", url: "https://www.cnbc.com/2026/02/27/openai-pentagon-deal-military-ai.html", vendor: "OpenAI", ts: "2026-02-27T20:00:00Z", isNew: true, score: 82 },
  { id: 5, sev: "high", cat: "regulatory", title: "EU AI Act: Annex III High-Risk Rules Take Effect August 2026", summary: "Organizations must demonstrate full data lineage, human-in-the-loop checkpoints, and risk classification tags. Non-compliance risks EU market access bans.", source: "European Commission", url: "https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai", vendor: null, ts: "2026-03-15T09:00:00Z", isNew: true, score: 85 },
  { id: 6, sev: "high", cat: "safety_research", title: "Only 3 of 7 Frontier Labs Substantively Test for Dangerous Capabilities", summary: "FLI Safety Index: Anthropic, OpenAI, and Google DeepMind only firms with real catastrophic risk testing. Gap widening. External evaluations minimal across the board.", source: "Future of Life Institute", url: "https://futureoflife.org/ai-safety-index/", vendor: null, ts: "2026-01-14T12:00:00Z", isNew: false, score: 78 },
  { id: 7, sev: "high", cat: "regulatory", title: "Trump Executive Order Targets State AI Laws via Litigation", summary: "December order directed AG to challenge state AI laws conflicting with 'minimally burdensome' federal framework. Relies on litigation, not preemptive legislation. Prolonged uncertainty.", source: "MIT Technology Review", url: "https://www.technologyreview.com/2025/12/06/ai-executive-order-state-laws/", vendor: null, ts: "2026-01-05T14:00:00Z", isNew: false, score: 75 },
  { id: 8, sev: "medium", cat: "enforcement", title: "Bipartisan State AGs Warn AI Firms Over Harmful Chatbot Outputs", summary: "Letters to Meta, Google, OpenAI demanding stronger safeguards. Called outputs 'sycophantic and delusional.' Demanded audits and transparency by Jan 16, 2026.", source: "State AG Coalition", url: "https://www.naag.org/issues/technology/artificial-intelligence/", vendor: null, ts: "2025-12-12T10:00:00Z", isNew: false, score: 58 },
  { id: 9, sev: "medium", cat: "standards", title: "NIST Publishes AI Standards Evaluation Approach (GCR-26-069)", summary: "New framework for evaluating effectiveness and relative value of AI standards development. Intended to stimulate structured measurement of standards impact on innovation and trust.", source: "NIST", url: "https://www.nist.gov/artificial-intelligence", vendor: null, ts: "2026-01-15T08:00:00Z", isNew: false, score: 52 },
  { id: 10, sev: "medium", cat: "frameworks", title: "Partnership on AI: Six Governance Priorities for 2026", summary: "Scalable evaluation frameworks, accountability infrastructure for agentic AI, assurance mechanisms, documentation artifacts across AI value chain, sovereignty strategies.", source: "Partnership on AI", url: "https://partnershiponai.org/programs/", vendor: null, ts: "2026-02-19T11:00:00Z", isNew: false, score: 55 },
  { id: 11, sev: "medium", cat: "safety_research", title: "Shadow AI Driving $670K Average Additional Breach Costs", summary: "IBM research: organizations with unmanaged AI observe significant cost increases. Highlights critical need for AI inventory, usage governance, and shadow AI detection.", source: "IBM Security", url: "https://www.ibm.com/reports/data-breach", vendor: null, ts: "2026-02-01T10:00:00Z", isNew: false, score: 50 },
  { id: 12, sev: "low", cat: "standards", title: "MCP Protocol Adoption Accelerates Across Major AI Vendors", summary: "Anthropic, OpenAI, Google, Microsoft, AWS rally around Model Context Protocol for AI agent interoperability. Governance implications for agent oversight and tool access.", source: "Anthropic", url: "https://modelcontextprotocol.io/", vendor: null, ts: "2025-12-12T16:00:00Z", isNew: false, score: 35 },
];
...
const FEEDS = [
  ...
  { name: "OpenAI Blog", type: "Scrape", freq: "6h", cat: "Vendor" },
  { name: "Anthropic Research", type: "RSS", freq: "6h", cat: "Vendor" },
  { name: "DeepMind Blog", type: "RSS", freq: "12h", cat: "Vendor" },
  { name: "Meta AI Blog", type: "Scrape", freq: "12h", cat: "Vendor" },
  { name: "Microsoft AI", type: "RSS", freq: "12h", cat: "Vendor" },
  ...
  { name: "Future of Life", type: "RSS", freq: "12h", cat: "Safety" },
  { name: "Partnership on AI", type: "Scrape", freq: "12h", cat: "Frameworks" },
          ...
          {critCount > 0 && (<div className="ao-enter ao-enter-2" style={{ background: "linear-gradient(135deg, rgba(239,68,68,0.06) 0%, rgba(239,68,68,0.02) 100%)", border: "1px solid rgba(239,68,68,0.15)", borderRadius: "var(--radius)", padding: 22, marginBottom: 24 }}>
            ...
            {ALERTS.filter(a => a.sev === "critical").map((a, i) => (
              <div key={a.id} style={{ padding: "14px 16px", marginBottom: i < critCount - 1 ? 10 : 0, background: "rgba(0,0,0,0.25)", borderRadius: 8, borderLeft: "3px solid #EF4444" }}>
                ...
                <div style={{ fontWeight: 600, fontSize: 14, color: "var(--text-0)", marginBottom: 6, lineHeight: 1.4 }}>{a.title}</div>
            ...
            {filtered.map(a => {
              ...
              return (
                <div key={a.id} className="ao-alert-row" onClick={() => setExpanded(isOpen ? null : a.id)} style={{ borderLeft: `3px solid ${SEV[a.sev].color}` }}>
                  ...
                  <div style={{ fontWeight: 600, fontSize: 14, color: "var(--text-0)", lineHeight: 1.4 }}>{a.title}</div>
